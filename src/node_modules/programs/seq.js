...
ProgramSeq.prototype = new ProgramBase.ProgramBase();
ProgramSeq.prototype.constructor = ProgramSeq;

ProgramSeq.prototype.parse_command_line=function() {
	var parser = new PosixGetOpt.BasicParser(':f:(format)s:(separator)w(equal-width)\u1000(help)\u1001(version)', this.argv);
