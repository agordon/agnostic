...
ProgramCat.prototype = new ProgramBase.ProgramBase();
ProgramCat.prototype.constructor = ProgramCat;

ProgramCat.prototype.parse_command_line=function() {
	var parser = new PosixGetOpt.BasicParser('A(show-all)b(number-nonblank)eE(show-ends)n(number)s(squeeze_blank)tT(show-tabs)uv(show-nonprinting)\u1000(help)\u1001(version)', this.argv);
