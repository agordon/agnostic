...
ProgramTac.prototype = new ProgramBase.ProgramBase();
ProgramTac.prototype.constructor = ProgramTac;

ProgramTac.prototype.parse_command_line=function() {
	var parser = new PosixGetOpt.BasicParser(':b(before)r(regex)s:(separator)\u1000(help)\u1001(version)', this.argv);
...
ProgramTac.prototype.tac_content=function(content) {
	content.reverse();
	this.runtime.stdout.put_lines(content);
}

ProgramTac.prototype.tac_stdin=function() {
	var content = this.runtime.stdin.get_all_lines();
	this.tac_content(content);
}

ProgramTac.prototype.tac_file=function(filename) {
	var fl = {} ;
	try {
