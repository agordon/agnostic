...
ProgramHead.prototype = new ProgramBase.ProgramBase();
ProgramHead.prototype.constructor = ProgramHead;

ProgramHead.prototype.parse_command_line=function() {
	var parser = new PosixGetOpt.BasicParser(':1234567890c:(bytes)n:(lines)q(quiet)v(verbose)\u1002(silent)\u1000(help)\u1001(version)', this.argv);
...
ProgramHead.prototype.head_content=function(content) {
...
ProgramHead.prototype.head_stdin=function() {
	if (this.verbose)
...
ProgramHead.prototype.head_file=function(filename) {
	var fl = {} ;
	try {
