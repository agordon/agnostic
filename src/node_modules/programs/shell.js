...
//NOTE:
//This file is auto-generated using PegJS from the posix syntax file.
//See the Makefile for details.
var posix_shell_parser = require("shell/posix_shell_parser.js");

module.exports = ProgramShell;
...
ProgramShell.prototype = new ProgramBase();
...
ProgramShell.prototype.internal_run=function() {
	...
	try {
		...
		var shell_parse_tree = posix_shell_parser.parse(this.command_or_script);
		var exec = new ShellExecutor(this.runtime, this.external_programs);
		exit_code = exec.ExecuteCommand(shell_parse_tree);
	} catch (e) {
		if (e instanceof posix_shell_parser.SyntaxError) {
