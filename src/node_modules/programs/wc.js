...
ProgramWc.prototype = new ProgramBase.ProgramBase();
ProgramWc.prototype.constructor = ProgramWc;

ProgramWc.prototype.parse_command_line=function() {
	var parser = new PosixGetOpt.BasicParser(':c(bytes)m(chars)l(lines)L(max-line-length)w(words)\u1002:(files0-from)\u1000(help)\u1001(version)', this.argv);
...
ProgramWc.prototype.wc_content=function(filename,content) {
	...
	for (var i in content) {
		...
		_words = line.trimWhitespace().split(/[ \t]+/).length ;
	}
