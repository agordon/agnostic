...
ProgramCut.prototype = new ProgramBase.ProgramBase();
ProgramCut.prototype.constructor = ProgramCut;

ProgramCut.prototype.parse_command_line=function() {
	var parser = new PosixGetOpt.BasicParser('b:(bytes)f:(fields)c:(characters)d:(delimiter)n\u1005(complement)s(only-delimiter)\u1006:(output-delimiter)\u1000(help)\u1001(version)', this.argv);
