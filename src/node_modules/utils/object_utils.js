...
this.VerifyObject = function (obj) {
	if (!this.IsObject(obj))
		throw new TypeError("'obj' is not a valid object: " + JSON.jsonify(obj));
}
...
this.VerifyArray = function (obj) {
	if (!this.IsArray(obj))
		throw new TypeError("'obj' is not a valid array:" + JSON.jsonify(obj));
}
	...
	for (var key in obj) {
		...
		if (! (key in allowed_keys) )
			throw new TypeError(
				...
				" allowed-keys = '" + allowed_keys_array.toString() + "': " + JSON.jsonify(obj));
	}
}
...
this.VerifyOneKey = function(obj) {
	...
	if (Object.keys(obj).length>1)
		throw new TypeError("'obj' contains more than one key: " +  JSON.jsonify(obj));
}
