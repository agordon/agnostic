...
var describeShell_HTML_Command = require('shell/shell_HTML_descriptor');
...
for (var t in tests)
{
	...
	try {
		...
		var desc = describeShell_HTML_Command(parse_tree);
...
console.log ("--Shell-HTML-Descriptor Tests Summary--");
